<template>
  <div class="min-template" :style="rootStyle">
...
const rootStyle = computed(()=>({backgroundColor:props.template?.colorScheme?.background||'#fff',color:props.template?.colorScheme?.text||'#171717',padding:`${gs.value.pagePadding||40}px`,minHeight:'100%',width:'100%'}))
</script>
<style scoped>.min-template{width:100%;max-width:794px;margin:0 auto}</style>
